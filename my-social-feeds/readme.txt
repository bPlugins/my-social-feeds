...
= 1.0.7 - 11 July, 2026 =
* Update: Redesigned the shortcode area with a modern one-click "Copy" button and copy confirmation.
* Update: Added a promotion card to the Twitter authorization and settings area.
* Update: Added new modern dashboard both plugin pro and free.
* Improved: Overall code quality and strengthened security protocols.
* Improvement: Fully optimized codebase to align with WordPress Plugin Check (PCP) standards.


= 1.0.6 - 10 June, 2026 =
* Features to change the text of the 'Follow' and 'Load More' buttons are available.
