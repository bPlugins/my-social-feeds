 ...
 * @fs_premium_only /vendor/freemius, /old-pinterest-feed
...
if (function_exists('msfbp_fs')) {
	...
	define('MSFBP_VERSION', ( defined('WP_DEBUG') && WP_DEBUG ) ? (string) time() : '1.0.7');
	...
	define('MSFBP_IS_PRO', file_exists(dirname(__FILE__) . '/vendor/freemius/start.php'));
